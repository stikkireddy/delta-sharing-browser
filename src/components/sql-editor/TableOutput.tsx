...
// const columns = [...Array(100).keys()].map((n) => ({
//     name: `col${n}`
// }))
//
// const rows = [...Array(100).keys()].map((rowN) => {
//     let row: Record<string, string> = {}
//     columns.forEach((col) => {
//         row[col.name] = `hello world ${col.name}`
//     })
//     return row
// })
...
export const TableOutput = () => {
    ...
    // return <MaterialTable columns={columns} data={data} title='Books Directory' />
    return (
        <Paper sx={{width: '100%',
            overflow: 'hidden',
            position: 'relative'}}>
